            ...
            SigningSpecifications signingSpecifications)
        {
            ...
            /*
                ...
                For author and repository signatures:
                    ...
                    * the signing-certificate-v2 attribute must contain exactly one ESSCertIDv2 structure per certificate
                      in the signing certificate chain (per X509Chain.ChainElements) in order from the signing certificate
