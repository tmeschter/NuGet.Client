...
namespace NuGet.Packaging.Signing
{
    ...
    public sealed class Signature
    {
        ...
        public static Signature Load(SignedCms cms)
        {
            ...
            VerifySigningCertificates(cms, signerInfo, signingSpecifications);
        ...
        private static void VerifySigningCertificates(
            SignedCms signedCms,
            SignerInfo signerInfo,
            SigningSpecifications signingSpecifications)
        {
            var certificates = SignatureUtility.GetPrimarySignatureSigningCertificates(
                signedCms,
                signerInfo,
