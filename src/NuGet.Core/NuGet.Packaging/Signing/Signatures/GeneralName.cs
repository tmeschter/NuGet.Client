    ...
    */
    ...
    public sealed class GeneralName
    {
        ...
        internal static GeneralName Read(DerSequenceReader reader)
        {
            ...
            {
                var content = reader.ReadContent((DerSequenceReader.DerTag)DerSequenceReader.ContextSpecificConstructedTag4);
                var directoryName = new X500DistinguishedName(content);
        ...
        internal byte[][] Encode()
        {
            ...
            var tag = reader.PeekTag();
            var content = reader.ReadContent((DerSequenceReader.DerTag)tag);
            var lengthByteCount = reader.ContentLength - 1 - content.Length;
