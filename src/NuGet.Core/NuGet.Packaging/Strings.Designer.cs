...
namespace NuGet.Packaging {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to A certificate chain could not be built from the SignedCms.Certificates collection..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to signing-certificate-v2 attribute validation failed..
        /// </summary>
        internal static string SigningCertificateV2ValidationFailed {
            get {
                return ResourceManager.GetString("SigningCertificateV2ValidationFailed", resourceCulture);
            }
        }
